...
namespace Pede_RocaAPP.Domain.Test
{
    public class EnderecoUnitTest
    {
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "SP", "Rua Para", 12, new Guid());
        ...
        {
            Action action = () => new Endereco("15991510", "Matão", "SP", "Rua Para", 12, new Guid());
        ...
        {
            Action action = () => new Endereco("", "Matão", "SP", "Rua Para", 12, new Guid());
            action.Should().Throw<DomainExceptionValidation>().WithMessage("CEP inválido, deve estar no formato 00000-000.");
        }
        ...
        {
            Action action = () => new Endereco("15991-510", "M", "SP", "Rua Para", 12, new Guid());
        ...
        public void CreateEndereco_ParametrosInvalidos_CidadeMaior()
        {
            ...
            Action action = () => new Endereco("15991-510", cidade, "SP", "Rua Para", 12, new Guid());
            action.Should().Throw<DomainExceptionValidation>().WithMessage("A cidade deve ter entre 2 e 100 caracteres.");
        }
        ...
        {
            Action action = () => new Endereco("15991-510", "", "SP", "Rua Para", 12, new Guid());
            action.Should().Throw<DomainExceptionValidation>().WithMessage("A cidade deve ter entre 2 e 100 caracteres.");
        }
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "São", "Rua Para", 12, new Guid());
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "", "Rua Para", 12, new Guid());
            action.Should().Throw<DomainExceptionValidation>().WithMessage("O estado deve ter 2 caracteres.");
        }
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "SP", "Av", 12, new Guid());
        ...
        public void CreateEndereco_ParametrosInvalidos_LogradouroMaior()
        {
            ...
            Action action = () => new Endereco("15991-510", "Matão", "SP", logradouro, 12, new Guid());
            action.Should().Throw<DomainExceptionValidation>().WithMessage("O logradouro deve ter entre 3 e 150 caracteres.");
        }
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "SP", "", 12, new Guid());
            action.Should().Throw<DomainExceptionValidation>().WithMessage("O logradouro deve ter entre 3 e 150 caracteres.");
        }
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "SP", "Rua Para", 0, new Guid());
        ...
        {
            Action action = () => new Endereco("15991-510", "Matão", "SP", "Rua Para", 12, Guid.Empty);
